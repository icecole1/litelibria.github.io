function page_schedule() {
  ...
  var url_pop_0 = config["titels_api"]+'getSchedule?days=0&remove=torrents,player.playlist&description_type=html';
  var url_pop_1 = config["titels_api"]+'getSchedule?days=1&remove=torrents,player.playlist&description_type=html';
  var url_pop_2 = config["titels_api"]+'getSchedule?days=2&remove=torrents,player.playlist&description_type=html';
  var url_pop_3 = config["titels_api"]+'getSchedule?days=3&remove=torrents,player.playlist&description_type=html';
  var url_pop_4 = config["titels_api"]+'getSchedule?days=4&remove=torrents,player.playlist&description_type=html';
  var url_pop_5 = config["titels_api"]+'getSchedule?days=5&remove=torrents,player.playlist&description_type=html';
  var url_pop_6 = config["titels_api"]+'getSchedule?days=6&remove=torrents,player.playlist&description_type=html';
